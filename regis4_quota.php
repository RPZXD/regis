        ...
        <div class="card card-outline card-primary">
          ...
          <div class="card-body">
            ...
            <form id="regForm" method="POST" enctype="multipart/form-data">
              ...
              <div id="steps">
                <!-- ขั้นตอนที่ 1 ถึง 7 -->
                <div class="tab"><?php include 'stepregm4_qaota/step1.php'; ?></div>
                <div class="tab"><?php include 'stepregm4_qaota/step2.php'; ?></div>
                <div class="tab"><?php include 'stepregm4_qaota/step3.php'; ?></div>
                <div class="tab"><?php include 'stepregm4_qaota/step4.php'; ?></div>
                <div class="tab"><?php include 'stepregm4_qaota/step5.php'; ?></div>
                <div class="tab"><?php include 'stepregm4_qaota/step6.php'; ?></div>
                <div class="tab"><?php include 'stepregm4_qaota/step7.php'; ?></div>
...
<script>
  ...
  function nextPrev(n) {
    ...
    // ตรวจสอบให้แน่ใจว่าแบบฟอร์มถูกต้องก่อนกดปุ่ม Next
  ...
  function validateForm() {
    ...
    // Additional validation for citizenid
    var citizenid = document.getElementById("citizenid");
    if (citizenid && citizenid.value.length !== 13) {
        citizenid.classList.add("is-invalid");
        valid = false;
    } else if (citizenid) {
        citizenid.classList.remove("is-invalid");
    }
