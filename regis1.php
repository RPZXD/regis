      ...
      <div class="register-box col-md-12 col-12">
        <div class="card card-outline card-primary">
          <div class="card-header text-center">
            <h3>สมัครเรียนมัธยมศึกษาปีที่ 1 (ในเขต / นอกเขต)</h3>
          </div>
          <div class="card-body">
            ...
            <form id="regForm" method="POST" enctype="multipart/form-data">
              ...
              <div id="steps">
                <!-- ขั้นตอนที่ 1 ถึง 7 -->
                <div class="tab"><?php include 'stepregm1/step1.php'; ?></div>
                <div class="tab"><?php include 'stepregm1/step2.php'; ?></div>
                <div class="tab"><?php include 'stepregm1/step3.php'; ?></div>
                <div class="tab"><?php include 'stepregm1/step4.php'; ?></div>
                <div class="tab"><?php include 'stepregm1/step5.php'; ?></div>
                <div class="tab"><?php include 'stepregm1/step6.php'; ?></div>
                <div class="tab"><?php include 'stepregm1/step7.php'; ?></div>
