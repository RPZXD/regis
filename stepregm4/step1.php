...
<h4><label class="text-primary">ประเภทการสมัคร</label></h4>
                  <div class="row mb-3">
                    <div class="custom-control custom-radio my-2"><h5>
                      <input class="custom-control-input" type="radio" name="typeregis" id="typeregis1" value="รอบทั่วไป" checked>
                      <label class="custom-control-label" for="typeregis1">รอบทั่วไป</label></h5>
                    </div>
