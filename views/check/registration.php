...
<div class="space-y-6">
    ...
    <div class="text-center">
        <h1 class="text-3xl font-bold gradient-text">ค้นหาสถานะการสมัคร</h1>
        <p class="mt-2 text-gray-600 dark:text-gray-400">ตรวจสอบสถานะการสมัครของคุณ</p>
    </div>
    ...
    <div class="max-w-2xl mx-auto">
        <div class="glass rounded-2xl p-8">
            <form id="searchForm" class="space-y-6">
                <div class="text-center">
                    <div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-primary-500 to-primary-600 rounded-2xl shadow-lg shadow-primary-500/30 mb-4">
                ...
                <button type="submit" class="w-full py-4 px-6 bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-white font-bold rounded-xl shadow-lg shadow-primary-500/30 hover:shadow-primary-500/50 transition-all transform hover:-translate-y-1">
                    <i class="fas fa-search mr-2"></i>ค้นหา
                </button>
                
                <p class="text-center text-sm text-red-500">*** กรุณากรอกเลขบัตรประชาชน 13 หลัก หรือ ชื่อเพื่อค้นหาสถานะการสมัคร ***</p>
            </form>
        </div>
    </div>
        ...
        <div class="glass rounded-2xl p-6 border-l-4 border-green-500">
            <div class="flex items-start space-x-4">
                <div class="flex-shrink-0">
                    <div class="w-12 h-12 flex items-center justify-center bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400 rounded-xl">
