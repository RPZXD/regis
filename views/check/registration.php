...
<div class="space-y-8">
    ...
    <div class="text-center relative">
        <div class="absolute inset-0 bg-gradient-to-r from-emerald-500/10 via-green-500/10 to-teal-500/10 rounded-3xl blur-3xl -z-10"></div>
        <div class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-emerald-500 to-green-600 rounded-3xl shadow-2xl shadow-emerald-500/40 mb-6 animate-bounce-slow">
            <i class="fas fa-search text-3xl text-white"></i>
        </div>
        <h1 class="text-4xl font-bold bg-gradient-to-r from-emerald-600 via-green-600 to-teal-600 bg-clip-text text-transparent">
            ค้นหาสถานะการสมัคร
        </h1>
    ...
    <div id="studentInfo" class="max-w-3xl mx-auto hidden animate-fade-in">
        ...
        <div class="glass rounded-3xl overflow-hidden shadow-xl mb-6">
            ...
            <div class="p-6">
                ...
                <!-- Quick Actions -->
                <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700 grid grid-cols-1 md:grid-cols-3 gap-3">
                    <a id="uploadLink" href="#" class="flex items-center justify-center px-4 py-3 bg-amber-100 dark:bg-amber-900/30 hover:bg-amber-200 dark:hover:bg-amber-900/50 text-amber-700 dark:text-amber-400 rounded-xl transition-colors">
                        <i class="fas fa-upload mr-2"></i>อัพโหลดเอกสาร
                    </a>
                    <a id="printLink" href="#" class="flex items-center justify-center px-4 py-3 bg-blue-100 dark:bg-blue-900/30 hover:bg-blue-200 dark:hover:bg-blue-900/50 text-blue-700 dark:text-blue-400 rounded-xl transition-colors">
                        <i class="fas fa-print mr-2"></i>พิมพ์ใบสมัคร
                    </a>
                    <a id="checkDocsLink" href="#" class="flex items-center justify-center px-4 py-3 bg-teal-100 dark:bg-teal-900/30 hover:bg-teal-200 dark:hover:bg-teal-900/50 text-teal-700 dark:text-teal-400 rounded-xl transition-colors">
