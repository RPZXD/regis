    ...
    <div class="flex items-center justify-center min-h-screen px-4 py-8">
        ...
        <div class="relative glass rounded-2xl w-full max-w-5xl max-h-[90vh] flex flex-col shadow-2xl">
            ...
            <div class="flex border-b border-gray-200 dark:border-gray-700 px-6 space-x-6 overflow-x-auto">
                <button onclick="switchTab('tab-general')"
                    class="tab-btn active py-4 text-sm font-medium border-b-2 border-primary-500 text-primary-600">ข้อมูลทั่วไป</button>
                <?php if (!$isSpecialType): ?>
                    <button onclick="switchTab('tab-address')"
                        class="tab-btn py-4 text-sm font-medium border-b-2 border-transparent text-gray-500 hover:text-gray-700">ที่อยู่</button>
                <?php endif; ?>
                <button onclick="switchTab('tab-education')"
                    class="tab-btn py-4 text-sm font-medium border-b-2 border-transparent text-gray-500 hover:text-gray-700">การศึกษาเดิม</button>
                <?php if (!$isSpecialType): ?>
                    <button onclick="switchTab('tab-family')"
                        class="tab-btn py-4 text-sm font-medium border-b-2 border-transparent text-gray-500 hover:text-gray-700">ครอบครัว</button>
                <?php else: ?>
                    <button onclick="switchTab('tab-guardian')"
                        class="tab-btn py-4 text-sm font-medium border-b-2 border-transparent text-gray-500 hover:text-gray-700">ผู้ปกครอง</button>
                <?php endif; ?>
                <button onclick="switchTab('tab-plans')"
                    class="tab-btn py-4 text-sm font-medium border-b-2 border-transparent text-gray-500 hover:text-gray-700">แผนการเรียน</button>
            </div>
            ...
            <form id="editStudentForm" class="flex-1 overflow-hidden flex flex-col">
                ...
                <div class="flex-1 overflow-y-auto p-6 space-y-6">
                    ...
                    <div id="tab-education" class="tab-content hidden space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="editGpaTotal"
                                    class="input-field bg-yellow-50 dark:bg-yellow-900/10 border-yellow-200">
                            </div>
                            <div>
                    ...
                    <!-- Tab: Family (Hidden for Special Classroom) -->
                    <?php if (!$isSpecialType): ?>
                        <div id="tab-family" class="tab-content hidden space-y-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                                    <div><label class="label-text">คำนำหน้า</label><input type="text" id="editDadPrefix"
                                            class="input-field"></div>
                                    <div><label class="label-text">ชื่อ</label><input type="text" id="editDadName"
                                            class="input-field"></div>
                                    <div><label class="label-text">นามสกุล</label><input type="text" id="editDadLastname"
                                            class="input-field"></div>
                                    <div><label class="label-text">อาชีพ</label><input type="text" id="editDadJob"
                                            class="input-field"></div>
                                    <div><label class="label-text">เบอร์โทร</label><input type="text" id="editDadTel"
                                            class="input-field"></div>
                                </div>
                            </div>
                            <!-- Mom -->
                            <div class="space-y-3">
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                                    <div><label class="label-text">คำนำหน้า</label><input type="text" id="editMomPrefix"
                                            class="input-field"></div>
                                    <div><label class="label-text">ชื่อ</label><input type="text" id="editMomName"
                                            class="input-field"></div>
                                    <div><label class="label-text">นามสกุล</label><input type="text" id="editMomLastname"
                                            class="input-field"></div>
                                    <div><label class="label-text">อาชีพ</label><input type="text" id="editMomJob"
                                            class="input-field"></div>
                                    <div><label class="label-text">เบอร์โทร</label><input type="text" id="editMomTel"
                                            class="input-field"></div>
                                </div>
                            </div>
                            <!-- Parent -->
                            <div class="space-y-3">
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                                    <div><label class="label-text">ความสัมพันธ์</label><input type="text"
                                            id="editParentRelation" class="input-field"></div>
                                    <div><label class="label-text">คำนำหน้า</label><input type="text" id="editParentPrefix"
                                            class="input-field"></div>
                                    <div><label class="label-text">ชื่อ</label><input type="text" id="editParentName"
                                            class="input-field"></div>
                                    <div><label class="label-text">นามสกุล</label><input type="text" id="editParentLastname"
                                            class="input-field"></div>
                                    <div><label class="label-text">อาชีพ</label><input type="text" id="editParentJob"
                                            class="input-field"></div>
                                    <div><label class="label-text">เบอร์โทร</label><input type="text" id="editParentTel"
                                            class="input-field"></div>
                                </div>
                            </div>
                        </div>
                    <?php else: ?>
                        <!-- Tab: Guardian Only (for Special Classroom) -->
                        <div id="tab-guardian" class="tab-content hidden space-y-4">
                            <h4 class="font-bold text-gray-700 dark:text-gray-300 border-b pb-2">ข้อมูลผู้ปกครอง</h4>
                ...
                <div
                    ...
                    <button type="submit"
                        class="px-6 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold rounded-lg hover:shadow-lg transition-all transform hover:-translate-y-0.5">บันทึกข้อมูล</button>
                </div>
            </form>
        </div>
    </div>
...
<style>
    ...
    .input-field {
        @apply w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 outline-none transition-all;
    }
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.edit-btn', function () {
            ...
            $.ajax({
                ...
                success: function (r) {
                    ...
                    $('#editGpaSci').val(r.grade_science);
                    $('#editGpaMath').val(r.grade_math);
                    $('#editGpaEng').val(r.grade_english);
        ...
        $('#editStudentForm').on('submit', function (e) {
            ...
            // Build data object - only include fields that exist in DOM
            var data = {
                ...
                grade_science: $('#editGpaSci').val(),
                grade_math: $('#editGpaMath').val(),
                grade_english: $('#editGpaEng').val(),
            ...
            // Conditionally add Address fields (not present for special type)
            if ($('#editNowAddr').length) {
                data.now_addr = $('#editNowAddr').val();
                data.now_moo = $('#editNowMoo').val();
                data.now_soy = $('#editNowSoy').val();
                data.now_street = $('#editNowStreet').val();
                data.now_subdistrict = $('#editNowSubdistrict').val();
                data.now_district = $('#editNowDistrict').val();
                data.now_province = $('#editNowProvince').val();
                data.now_post = $('#editNowPost').val();
            }

            // Conditionally add Family fields (not present for special type)
            if ($('#editDadPrefix').length) {
                data.dad_prefix = $('#editDadPrefix').val();
                data.dad_name = $('#editDadName').val();
                data.dad_lastname = $('#editDadLastname').val();
                data.dad_job = $('#editDadJob').val();
                data.dad_tel = $('#editDadTel').val();

                data.mom_prefix = $('#editMomPrefix').val();
                data.mom_name = $('#editMomName').val();
                data.mom_lastname = $('#editMomLastname').val();
                data.mom_job = $('#editMomJob').val();
                data.mom_tel = $('#editMomTel').val();
            }
