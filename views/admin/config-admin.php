    ...
    <div class="glass rounded-2xl overflow-hidden">
        <div class="border-b border-gray-200 dark:border-gray-700">
            <nav class="flex -mb-px overflow-x-auto" id="configTabs">
                ...
                <button onclick="showTab('documents')" class="tab-btn px-6 py-4 text-sm font-medium whitespace-nowrap border-b-2 border-transparent text-gray-500 hover:text-gray-700" data-tab="documents">
        ...
        <div class="p-6">
            ...
            <div id="tab-documents" class="tab-content hidden">
                <div class="flex justify-between items-center mb-4">
                    <select id="filterDocType" class="px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-slate-700">
                        <option value="">-- เลือกประเภทการสมัคร --</option>
                    </select>
                    <button onclick="showAddDocModal()" class="px-4 py-2 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-lg shadow hover:shadow-lg transition-all">
    ...
    <div class="flex items-center justify-center min-h-screen p-4">
        ...
        <div class="relative glass rounded-2xl max-w-md w-full p-6">
            ...
            <form id="addDocForm" class="space-y-4">
                <div>
                    <label class="block text-sm font-medium mb-2">ประเภทการสมัคร</label>
                    <select name="registration_type_id" required class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-slate-700" id="typeSelectDoc"></select>
                </div>
                <div>
                    <label class="block text-sm font-medium mb-2">ชื่อเอกสาร</label>
                    <input type="text" name="name" required class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-slate-700" placeholder="เช่น สำเนาทะเบียนบ้าน">
                </div>
                <div>
                    <label class="block text-sm font-medium mb-2">คำอธิบาย (ไม่บังคับ)</label>
                    <textarea name="description" rows="2" class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-slate-700" placeholder="คำอธิบายเพิ่มเติม"></textarea>
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-medium mb-2">ประเภทไฟล์</label>
                        <input type="text" name="file_types" value="jpg,jpeg,png,pdf" class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-slate-700">
                    </div>
                    <div>
                        <label class="block text-sm font-medium mb-2">ขนาดสูงสุด (MB)</label>
                        <input type="number" name="max_size_mb" value="5" min="1" max="20" class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-slate-700">
                    </div>
                </div>
                ...
                <div class="flex justify-end space-x-3 mt-6">
                    <button type="button" onclick="closeModal('addDocModal')" class="px-4 py-2 bg-gray-200 dark:bg-gray-700 rounded-lg">ยกเลิก</button>
                    <button type="submit" class="px-4 py-2 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-lg">บันทึก</button>
                </div>
            </form>
        </div>
    ...
    <div class="flex items-center justify-center min-h-screen p-4">
        ...
        <div class="relative glass rounded-2xl max-w-md w-full p-6">
            ...
            <form id="editDocForm" class="space-y-4">
                ...
                <div>
                    <label class="block text-sm font-medium mb-2">ชื่อเอกสาร</label>
                    <input type="text" name="name" id="editDocName" required class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-slate-700">
                </div>
                <div>
                    <label class="block text-sm font-medium mb-2">คำอธิบาย</label>
                    <textarea name="description" id="editDocDesc" rows="2" class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-slate-700"></textarea>
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-medium mb-2">ประเภทไฟล์</label>
                        <input type="text" name="file_types" id="editDocFileTypes" class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-slate-700">
                    </div>
                    <div>
                        <label class="block text-sm font-medium mb-2">ขนาดสูงสุด (MB)</label>
                        <input type="number" name="max_size_mb" id="editDocMaxSize" min="1" max="20" class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-slate-700">
                    </div>
                </div>
                <div class="flex items-center gap-6">
                    <label class="flex items-center">
                        <input type="checkbox" name="is_required" id="editDocRequired" value="1" class="w-4 h-4 mr-2 text-green-600">
                        <span class="text-sm">บังคับอัพโหลด</span>
                    </label>
                    <label class="flex items-center">
                        <input type="checkbox" name="is_active" id="editDocActive" value="1" class="w-4 h-4 mr-2 text-green-600">
                        <span class="text-sm">เปิดใช้งาน</span>
                    </label>
                </div>
                <div class="flex justify-end space-x-3 mt-6">
                    <button type="button" onclick="closeModal('editDocModal')" class="px-4 py-2 bg-gray-200 dark:bg-gray-700 rounded-lg">ยกเลิก</button>
                    <button type="submit" class="px-4 py-2 bg-gradient-to-r from-amber-500 to-orange-600 text-white rounded-lg">บันทึกการแก้ไข</button>
                </div>
            </form>
        </div>
    </div>
            ...
            <form id="scheduleForm" class="space-y-4">
                ...
                <div class="p-4 rounded-xl bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="datetime-local" name="register_start" class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-slate-700">
                        </div>
                        <div>
                            <label class="block text-xs text-gray-500 mb-1">สิ้นสุด</label>
                            <input type="datetime-local" name="register_end" class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-slate-700">
                        </div>
                    </div>
                </div>
                ...
                <div class="p-4 rounded-xl bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-xs text-gray-500 mb-1">เริ่มต้น</label>
                            <input type="datetime-local" name="print_form_start" class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-slate-700">
                        </div>
                        <div>
                            <label class="block text-xs text-gray-500 mb-1">สิ้นสุด</label>
                            <input type="datetime-local" name="print_form_end" class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-slate-700">
                        </div>
                    </div>
                </div>
                ...
                <div class="p-4 rounded-xl bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-xs text-gray-500 mb-1">เริ่มต้น</label>
                            <input type="datetime-local" name="upload_start" class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-slate-700">
                        </div>
                        <div>
                            <label class="block text-xs text-gray-500 mb-1">สิ้นสุด</label>
                            <input type="datetime-local" name="upload_end" class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-slate-700">
                        </div>
                    </div>
                </div>
                ...
                <div class="p-4 rounded-xl bg-cyan-50 dark:bg-cyan-900/20 border border-cyan-200 dark:border-cyan-800">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-xs text-gray-500 mb-1">เริ่มต้น</label>
                            <input type="datetime-local" name="exam_card_start" class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-slate-700">
                        </div>
                        <div>
                            <label class="block text-xs text-gray-500 mb-1">สิ้นสุด</label>
                            <input type="datetime-local" name="exam_card_end" class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-slate-700">
                        </div>
                    </div>
                </div>
                ...
                <div class="p-4 rounded-xl bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-xs text-gray-500 mb-1">เริ่มต้น</label>
                            <input type="datetime-local" name="report_start" class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-slate-700">
                        </div>
                        <div>
                            <label class="block text-xs text-gray-500 mb-1">สิ้นสุด</label>
                            <input type="datetime-local" name="report_end" class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-slate-700">
                        </div>
                    </div>
                </div>
                ...
                <div class="p-4 rounded-xl bg-rose-50 dark:bg-rose-900/20 border border-rose-200 dark:border-rose-800">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-xs text-gray-500 mb-1">เริ่มต้น</label>
                            <input type="datetime-local" name="announce_start" class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-slate-700">
                        </div>
                        <div>
                            <label class="block text-xs text-gray-500 mb-1">สิ้นสุด</label>
                            <input type="datetime-local" name="announce_end" class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-slate-700">
                        </div>
                    </div>
                </div>
                
                <div class="flex justify-end space-x-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                    <button type="button" onclick="closeModal('scheduleModal')" class="px-4 py-2 bg-gray-200 dark:bg-gray-700 rounded-lg">ยกเลิก</button>
                    <button type="submit" class="px-6 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-semibold rounded-lg shadow hover:shadow-lg transition-all">
