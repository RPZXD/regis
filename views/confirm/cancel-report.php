        ...
        <div class="max-w-md mx-auto glass rounded-2xl p-8 shadow-xl">
            <form method="POST" action="" class="space-y-6">
                ...
                <button type="submit" name="search"
                    class="w-full py-3 bg-gradient-to-r from-red-600 to-rose-600 text-white rounded-xl font-bold hover:shadow-lg hover:scale-[1.02] transition-all">
                    ค้นหาข้อมูล
                </button>
            </form>
            <?php if (isset($error)): ?>
    ...
    <?php else: ?>
        ...
        <?php if ($currentStatus == 2): ?>
            ...
            <div class="max-w-2xl mx-auto glass rounded-2xl p-8 shadow-xl text-center">
                ...
                <div class="p-4 bg-green-50 rounded-xl border border-green-200 mb-6">
                    <p class="text-green-700"><i class="fas fa-info-circle mr-2"></i>ท่านได้ยืนยันสิทธิ์แล้ว
                        ไม่สามารถสละสิทธิ์ได้</p>
                </div>
                <a href="index.php"
                    class="inline-block px-8 py-3 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-xl font-bold">
        ...
        <?php elseif ($currentStatus == 3): ?>
            ...
            <div class="max-w-2xl mx-auto glass rounded-2xl p-8 shadow-xl text-center">
                ...
                <a href="index.php"
                    class="inline-block px-8 py-3 bg-gradient-to-r from-gray-500 to-gray-600 text-white rounded-xl font-bold">
                    <i class="fas fa-home mr-2"></i>กลับหน้าหลัก
                </a>
            </div>
        ...
        <?php elseif ($currentStatus != 1): ?>
            ...
            <div class="max-w-2xl mx-auto glass rounded-2xl p-8 shadow-xl text-center">
                ...
                <a href="index.php"
                    class="inline-block px-8 py-3 bg-gradient-to-r from-amber-500 to-orange-600 text-white rounded-xl font-bold">
                    <i class="fas fa-home mr-2"></i>กลับหน้าหลัก
                </a>
            </div>

        <?php elseif (isset($isReportPeriodValid) && !$isReportPeriodValid): ?>
            <!-- Not in period -->
            <div class="max-w-2xl mx-auto glass rounded-2xl p-8 shadow-xl text-center">
                <div class="w-24 h-24 bg-red-100 text-red-600 rounded-full flex items-center justify-center mx-auto mb-6">
                    <i class="fas fa-clock text-5xl"></i>
                </div>
                <h2 class="text-2xl font-bold text-red-700 mb-4">ไม่อยู่ในช่วงเวลารายงานตัว</h2>
                <p class="text-gray-600 mb-6 font-medium">
                    <?php echo $reportScheduleMsg; ?>
                </p>
                <a href="index.php"
                    class="inline-block px-8 py-3 bg-gradient-to-r from-gray-500 to-gray-600 text-white rounded-xl font-bold">
                    <i class="fas fa-home mr-2"></i>กลับหน้าหลัก
        ...
        <?php else: ?>
            ...
            <div class="max-w-2xl mx-auto glass rounded-2xl p-8 shadow-xl shadow-red-500/10 relative overflow-hidden">
                <div
                    class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-red-500/20 to-rose-500/20 rounded-bl-full -mr-8 -mt-8">
                </div>
                ...
                <div class="flex flex-col md:flex-row gap-4 justify-center mt-8">
                    <a href="confirm_report.php"
                        class="px-8 py-3 rounded-xl border border-gray-300 text-gray-600 hover:bg-gray-50 font-bold transition-all text-center">
                        <i class="fas fa-arrow-left mr-2"></i>ย้อนกลับ
                    </a>
                    <button onclick="cancelReport()"
                        class="px-12 py-3 rounded-xl bg-gradient-to-r from-red-500 to-rose-600 text-white font-bold shadow-lg shadow-red-500/30 hover:scale-105 transition-all">
