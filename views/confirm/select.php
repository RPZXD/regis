...
<div class="space-y-8">
    ...
    <div class="text-center">
        <h1 class="text-3xl font-bold gradient-text">รายงานตัว</h1>
        <p class="mt-2 text-gray-600 dark:text-gray-400">ยืนยันสิทธิ์หรือสละสิทธิ์การเข้าศึกษาต่อ</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        ...
        <a href="confirm_report.php" class="group glass rounded-2xl p-6 hover:shadow-xl transition-all transform hover:-translate-y-2">
            <div class="text-center">
                ...
                <p class="text-gray-600 dark:text-gray-400 mt-2">รายงานตัว ม.1</p>
        ...
        <a href="confirm_report.php" class="group glass rounded-2xl p-6 hover:shadow-xl transition-all transform hover:-translate-y-2">
            <div class="text-center">
                ...
                <p class="text-gray-600 dark:text-gray-400 mt-2">รายงานตัว ม.4</p>
    ...
    <!-- Instructions -->
    <div class="max-w-4xl mx-auto glass rounded-2xl p-6 border-l-4 border-amber-500">
        <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-4">
            <i class="fas fa-exclamation-triangle text-amber-500 mr-2"></i>ข้อควรทราบ
        </h3>
        <ul class="space-y-2 text-gray-600 dark:text-gray-300">
            <li class="flex items-start">
                <i class="fas fa-info-circle text-blue-500 mr-2 mt-1"></i>
                <span>กรุณายืนยันสิทธิ์ภายในระยะเวลาที่กำหนด</span>
            </li>
            <li class="flex items-start">
                <i class="fas fa-info-circle text-blue-500 mr-2 mt-1"></i>
                <span>หากสละสิทธิ์แล้วจะไม่สามารถยืนยันสิทธิ์ได้อีก</span>
            </li>
            <li class="flex items-start">
                <i class="fas fa-info-circle text-blue-500 mr-2 mt-1"></i>
                <span>ตรวจสอบข้อมูลให้ถูกต้องก่อนยืนยัน</span>
            </li>
        </ul>
    </div>
</div>
