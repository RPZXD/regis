        ...
        <div class="px-6 py-5 border-b border-white/10">
            <a href="index.php" class="flex items-center space-x-3 group">
                <div class="relative">
                    ...
                    <img src="dist/img/logo-phicha.png"
                        class="relative w-12 h-12 rounded-full ring-2 ring-white/20 group-hover:ring-primary-400 transition-all"
                        alt="Logo">
                </div>
                <div>
            ...
            <ul class="space-y-1">
                ...
                <li>
                    <a href="index.php"
                        ...
                        <span
                            class="w-10 h-10 flex items-center justify-center bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg shadow-lg shadow-blue-500/30 group-hover:shadow-blue-500/50 transition-shadow">
                ...
                <?php foreach ($activeMenus as $menu):
                    ...
                    ?>
                    <li>
                        <a href="<?php echo htmlspecialchars($menu['menu_url']); ?>"
                            class="sidebar-item flex items-center px-4 py-3 text-gray-300 rounded-xl hover:bg-white/10 hover:text-white group">
                            <span
                                class="w-10 h-10 flex items-center justify-center bg-gradient-to-br from-<?php echo $style['from']; ?> to-<?php echo $style['to']; ?> rounded-lg shadow-lg shadow-<?php echo explode('-', $style['from'])[0]; ?>-500/30 group-hover:shadow-<?php echo explode('-', $style['from'])[0]; ?>-500/50 transition-shadow">
                                <i class="fas <?php echo $style['icon']; ?> text-white"></i>
                            </span>
                            <span class="ml-3 font-medium"><?php echo htmlspecialchars($menu['menu_name']); ?></span>
                            <?php if ($badge): ?>
                                <span
                                    class="ml-auto px-2 py-0.5 text-xs font-bold bg-red-500 text-white rounded-full"><?php echo $badge; ?></span>
                            <?php endif; ?>
                        </a>
                    </li>
                <?php endforeach; ?>
                ...
                <!-- ผังห้องสอบ (New) -->
                <li>
                    <a href="exam-room.php"
                        class="sidebar-item flex items-center px-4 py-3 text-gray-300 rounded-xl hover:bg-white/10 hover:text-white group">
                        <span
                            class="w-10 h-10 flex items-center justify-center bg-gradient-to-br from-indigo-500 to-purple-600 rounded-lg shadow-lg shadow-indigo-500/30 group-hover:shadow-indigo-500/50 transition-shadow">
                            <i class="fas fa-chair text-white"></i>
                        </span>
                        <span class="ml-3 font-medium">ผังห้องสอบ</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="contact.php"
                        class="sidebar-item flex items-center px-4 py-3 text-gray-300 rounded-xl hover:bg-white/10 hover:text-white group">
                        <span
                            class="w-10 h-10 flex items-center justify-center bg-gradient-to-br from-slate-500 to-slate-600 rounded-lg shadow-lg shadow-slate-500/30 group-hover:shadow-slate-500/50 transition-shadow">
