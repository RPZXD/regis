...
<div class="space-y-8">
    ...
    <div class="text-center relative">
        <div class="absolute inset-0 bg-gradient-to-r from-indigo-500/10 via-violet-500/10 to-purple-500/10 rounded-3xl blur-3xl -z-10"></div>
        <div class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-indigo-500 to-violet-600 rounded-3xl shadow-2xl shadow-indigo-500/40 mb-6 animate-bounce-slow">
            <i class="fas fa-print text-3xl text-white"></i>
        </div>
        <h1 class="text-4xl font-bold bg-gradient-to-r from-indigo-600 via-violet-600 to-purple-600 bg-clip-text text-transparent">
            พิมพ์ใบสมัครเรียน
        </h1>
    ...
    <div id="studentInfo" class="max-w-3xl mx-auto hidden animate-fade-in">
        ...
        <div class="glass rounded-3xl overflow-hidden shadow-xl">
            ...
            <div class="p-6">
                ...
                <!-- Print Button -->
                <button id="printAppButton" class="w-full py-5 bg-gradient-to-r from-blue-500 via-cyan-500 to-teal-500 hover:from-blue-600 hover:via-cyan-600 hover:to-teal-600 text-white font-bold text-lg rounded-2xl shadow-lg shadow-blue-500/30 transition-all transform hover:-translate-y-1 hover:scale-[1.02] group">
