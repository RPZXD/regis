...
<div class="space-y-8">
    ...
    <div class="text-center relative">
        <div class="absolute inset-0 bg-gradient-to-r from-blue-500/10 via-cyan-500/10 to-teal-500/10 rounded-3xl blur-3xl -z-10"></div>
        <div class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-blue-500 to-cyan-600 rounded-3xl shadow-2xl shadow-blue-500/40 mb-6 animate-bounce-slow">
    ...
    <div id="studentInfo" class="max-w-3xl mx-auto hidden animate-fade-in">
        ...
        <div class="glass rounded-3xl overflow-hidden shadow-xl">
            ...
            <div class="p-6">
                ...
                <!-- Exam Info -->
                <div class="bg-blue-50 dark:bg-blue-900/20 rounded-2xl p-5 mb-6 border border-blue-100 dark:border-blue-800">
                ...
                <!-- Print Button -->
                <button id="printCardButton" class="w-full py-5 bg-gradient-to-r from-blue-500 via-cyan-500 to-teal-500 hover:from-blue-600 hover:via-cyan-600 hover:to-teal-600 text-white font-bold text-lg rounded-2xl shadow-lg shadow-blue-500/30 transition-all transform hover:-translate-y-1 hover:scale-[1.02] group">
...
document.getElementById('searchForm').addEventListener('submit', function(event) {
    ...
    .then(data => {
        ...
        if (data.exists) {
            ...
            // Check exam card schedule (using exam_card_start/end if exists)
