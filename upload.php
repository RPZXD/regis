                        ...
                        <div class="card-body">
                            ...
                            <form id="uploadForm" enctype="multipart/form-data">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <input type="file" class="form-control" id="document4" name="document4">
                                </div>
                                <div class="form-group mt-2">
                                    <label for="document5">5. สำเนาทะเบียนบ้านของมารดา
                                        <span class="text-danger">พร้อมลงลายมือชื่อรับรองสำเนาถูกต้อง หรือแบบรับรองรายการทะเบียนราษฎร (ท.ร. ๑๔) ที่ได้รับการรับรองจากหน่วยงานราชการ จำนวน ๑ ฉบับ</span>
                                    </label>
                                    <input type="file" class="form-control" id="document5" name="document5">
                                </div>
                                <div class="form-group mt-2">
                                    ...
                                    <input type="file" class="form-control" id="document6" name="document6">
                                </div>
                                <div class="form-group mt-2">
                                    ...
                                    <input type="file" class="form-control" id="document7" name="document7">
                                </div>
