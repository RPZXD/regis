    ...
    switch ($method) {
        ...
        case 'POST':
            ...
            if ($action === 'update' && isset($_POST['id'])) {
                ...
                $stmt = $db->prepare($sql);
                $result = $stmt->execute([
                    $_POST['register_start'] ?: null,
                    $_POST['register_end'] ?: null,
                    $_POST['print_form_start'] ?: null,
                    $_POST['print_form_end'] ?: null,
                    $_POST['upload_start'] ?: null,
                    $_POST['upload_end'] ?: null,
                    $_POST['exam_card_start'] ?: null,
                    $_POST['exam_card_end'] ?: null,
                    $_POST['report_start'] ?: null,
                    $_POST['report_end'] ?: null,
                    $_POST['announce_start'] ?: null,
                    $_POST['announce_end'] ?: null,
                    $id
                ]);
                echo json_encode(['success' => $result]);
            } else {
