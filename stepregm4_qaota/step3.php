...
<div class="row mb-3">
    ...
    <div class="col-sm-5">
        ...
        <!-- STUID old School -->
        <div class="col-sm-5">
        <label for="old_school_stuid">เลขประจำตัวโรงเรียนเดิม</label>
        <div class="input-group">

            <input 
                type="text" 
                id="old_school_stuid" 
                name="old_school_stuid" 
                class="form-control text-center" 
                placeholder="กรอกเลขประจำตัวโรงเรียนเดิม" 
                maxlength="10" 
                required 
                aria-label="Old School STUID"
            >
