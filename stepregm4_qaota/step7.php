...
<div class="row mb-3">
  ...
  <div class="col-sm-4">
    ...
    <div class="input-group">
        <input type="number" id="gpa_total" name="gpa_total" class="form-control text-center" max="4.00" min="0" step="0.01" required value="" oninput="validateStep(6)"> 
    </div>
  </div>
...
<div class="col-sm-6">
 <div class="input-group">
     <select class="form-control text-center" id="number1" name="number1" onchange="check();" required oninput="validateStep(6)">
...
<div class="col-sm-6">
 <div class="input-group">
     <select class="form-control text-center" id="number2" name="number2" onchange="check();" required oninput="validateStep(6)">
     <option class="text-center" value="" selected>โปรดระบุแผนการเรียน</option>
     <option class="text-center"  value="1">ห้อง 2 : วิทยาศาสตร์ คณิตศาสตร์ และเทคโนโลยี (Coding)</option>
     <option class="text-center"  value="2">ห้อง 3 : วิทยาศาสตร์พลังสิบ</option>
     <option class="text-center"  value="3">ห้อง 4 : วิทยาศาสตร์ คณิตศาสตร์</option>
...
<div class="col-sm-6">
 <div class="input-group">
     <select class="form-control text-center" id="number3" name="number3" onchange="check();" required oninput="validateStep(6)">
     <option class="text-center" value="" selected>โปรดระบุแผนการเรียน</option>
     <option class="text-center"  value="1">ห้อง 2 : วิทยาศาสตร์ คณิตศาสตร์ และเทคโนโลยี (Coding)</option>
     <option class="text-center"  value="2">ห้อง 3 : วิทยาศาสตร์พลังสิบ</option>
     <option class="text-center"  value="3">ห้อง 4 : วิทยาศาสตร์ คณิตศาสตร์</option>
...
<div class="col-sm-6">
 <div class="input-group">
     <select class="form-control text-center" id="number4" name="number4" onchange="check();" required oninput="validateStep(6)">
     <option class="text-center" value="" selected>โปรดระบุแผนการเรียน</option>
     <option class="text-center"  value="1">ห้อง 2 : วิทยาศาสตร์ คณิตศาสตร์ และเทคโนโลยี (Coding)</option>
     <option class="text-center"  value="2">ห้อง 3 : วิทยาศาสตร์พลังสิบ</option>
     <option class="text-center"  value="3">ห้อง 4 : วิทยาศาสตร์ คณิตศาสตร์</option>
...
<div class="col-sm-6">
 <div class="input-group">
     <select class="form-control text-center" id="number5" name="number5" onchange="check();" required oninput="validateStep(6)">
     <option class="text-center" value="" selected>โปรดระบุแผนการเรียน</option>
     <option class="text-center"  value="1">ห้อง 2 : วิทยาศาสตร์ คณิตศ้าสตร์ และเทคโนโลยี (Coding)</option>
     <option class="text-center"  value="2">ห้อง 3 : วิทยาศาสตร์พลังสิบ</option>
     <option class="text-center"  value="3">ห้อง 4 : วิทยาศาสตร์ คณิตศาสตร์</option>
     <option class="text-center"  value="4">ห้อง 5 : ศิลปศาสตร์และสังคมศาสตร์</option>
     <option class="text-center"  value="5">ห้อง 6 : ภาษาศาสตร์</option>
...
<div class="col-sm-6">
 <div class="input-group">
     <select class="form-control text-center" id="number6" name="number6" onchange="check();" required oninput="validateStep(6)">
     <option class="text-center" value="" selected>โปรดระบุแผนการเรียน</option>
     <option class="text-center"  value="1">ห้อง 2 : วิทยาศาสตร์ คณิตศาสตร์ และเทคโนโลยี (Coding)</option>
     <option class="text-center"  value="2">ห้อง 3 : วิทยาศาสตร์พลังสิบ</option>
     <option class="text-center"  value="3">ห้อง 4 : วิทยาศาสตร์ คณิตศาสตร์</option>
