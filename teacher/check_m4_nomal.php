                                ...
                                <table class="display table-bordered responsive" id="record_table" style="width:100%;">
                                    <thead class="table-dark text-white text-center">
                                        <tr>
                                            ...
                                            <th style="vertical-align: middle; text-align: center;">6.1 ระเบียนแสดงผลการเรียนหลักสูตรแกนกลางการศึกษาขั้นพื้นฐาน (หน้าแรก)</th>
                                            <th style="vertical-align: middle; text-align: center;">6.2 ระเบียนแสดงผลการเรียนหลักสูตรแกนกลางการศึกษาขั้นพื้นฐาน (หน้าหลัง)</th>
...
function loadTable() {
    $.ajax({
        url: 'api/fetch_m4nomal_check.php',
        method: 'GET',
        dataType: 'json',
        success: function(response) {
            ...
            if (response.length === 0) {
                $('#record_table tbody').append('<tr><td colspan="17" class="text-center">ไม่พบข้อมูล</td></tr>');
            } else {
