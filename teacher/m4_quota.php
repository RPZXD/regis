        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editStudentForm">
                    ...
                    <div class="mb-3">
                        <label for="editOldSchoolStuid" class="form-label">เลขประจำตัวโรงเรียนเดิม</label>
                        <input type="text" class="form-control" id="editOldSchoolStuid" required>
                    </div>
                    <div class="mb-3">
                        <label for="editNumber1" class="form-label">แผนการเรียน 1</label>
                        <select class="form-control" id="editNumber1" required>
                            <option value="1">ห้อง 2 : วิทยาศาสตร์ คณิตศาสตร์ และเทคโนโลยี (Coding)</option>
                            <option value="2">ห้อง 3 : วิทยาศาสตร์พลังสิบ</option>
                            <option value="3">ห้อง 4 : วิทยาศาสตร์ คณิตศาสตร์</option>
                            <option value="4">ห้อง 5 : ศิลปศาสตร์และสังคมศาสตร์</option>
                            <option value="5">ห้อง 6 : ภาษาศาสตร์</option>
                            <option value="6">ห้อง 7 : บริหารอุตสาหกรรม แผน การจัดการอาหาร</option>
                            <option value="7">ห้อง 7 : บริหารอุตสาหกรรม แผน การจัดการเกษตร</option>
                            <option value="8">ห้อง 7 : บริหารอุตสาหกรรม แผน การจัดการอุตสาหกรรม</option>
                        </select>
                    </div>
                    <div class="mb-3">
...
$(document).ready(function() {
    ...
    $(document).on('click', '.edit-btn', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#editOldSchoolStuid').val(response.old_school_stuid);
    ...
    document.getElementById("editStudentForm").addEventListener("submit", function(event) {
        ...
        const studentData = {
            ...
            old_school_stuid: document.getElementById("editOldSchoolStuid").value,
