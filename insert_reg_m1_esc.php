...
try {
    ...
    $data = [
        ...
        'gpa_total' => $_POST['gpa_total'] >= 3.00 ? $_POST['gpa_total'] : null,
        'gpa_sci' => $_POST['gpa_sci'] >= 3.00 ? $_POST['gpa_sci'] : null,
        'gpa_math' => $_POST['gpa_math'] >= 3.00 ? $_POST['gpa_math'] : null,
        'gpa_eng' => $_POST['gpa_eng'] >= 3.00 ? $_POST['gpa_eng'] : null,
        'number1' => '0',
        'number2' => '0',
        'number3' => '0',
        'number4' => '0',
    ...
    $sql = "INSERT INTO users (
                ...
                stu_ethnicity, stu_nationality, old_school, old_school_province, old_school_district, 
                ...
                gpa_total, gpa_sci, gpa_math, gpa_eng, number1, number2, number3, number4, number5, number6, number7, number8, 
                number9, number10
            ) VALUES (
                :citizenid, :date_birth, :month_birth, :year_birth, :stu_prefix, :stu_name, :stu_lastname, 
                :level, :roles, :reg_pee, :create_at, :typeregis, :stu_sex, :stu_blood_group, :stu_religion, 
