            ...
            <div class="col-md-8">
                <div class="card card-default">
                    <div class="card-header">
                        <h3 class="card-title">
                            <h2 class="text-center"><i class="fas fa-bullhorn"></i>&nbsp;&nbsp;ค้นหาข้อมูลเพื่อยืนยัน/สละสิทธิ์</h2>
                        </h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                    ...
                    <div class="form-row justify-content-center align-items-center form-control-lg">
                        <div class="col-auto">
                            <div id="studentInfo" class="callout callout-info d-none">
                                    ...
                                    <button id="ConfirmButton" class="btn btn-success mt-3 d-none"> ยืนยันสิทธิ์!</button>
                                    <button id="DisclaimButton" class="btn btn-danger mt-3 d-none"> สละสิทธิ์!</button>
                            </div>
                        </div>
                    </div>
                 </div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    endTime.setHours(12, 0, 0); // 12:00:00
