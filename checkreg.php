            ...
            <div class="col-md-8">
                <div class="card card-default">
                    <div class="card-header">
                        <h3 class="card-title">
                            <h2 class="text-center"><i class="fas fa-bullhorn"></i>&nbsp;&nbsp;ค้นหาสถานะการสมัคร</h2>
                        </h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        ...
                        <p class="text-center text-danger mt-3">*** กรุณากรอกเลขบัตรประชาชน 13 หลักหรือชื่อเพื่อค้นหาสถานะการสมัคร ***</p>
                    </div>
                    <!-- /.card-body -->
                </div>
                <!-- /.card -->
