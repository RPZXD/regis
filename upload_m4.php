            ...
            <div class="col-md-8">
                <div class="card card-default">
                    <div class="card-header">
                        <h3 class="card-title">
                            <h2 class="text-center text-lg"><i class="fas fa-bullhorn"></i>&nbsp;&nbsp;อัพโหลดหลักฐาน ผู้ที่จะสมัครเข้าศึกษามัธยมศึกษาปีที่ 4</h2>
                        </h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="uploadFormLevel4" enctype="multipart/form-data">
                                ...
                                <?php
                                    $documents1 = $uploads->selectConfigUploadsByLevel(4);
