            ...
            <div class="col-md-8">
                <div class="card card-default">
                    <div class="card-header">
                        <h3 class="card-title">
                            <h2 class="text-center"><i class="fas fa-bullhorn"></i>&nbsp;&nbsp;ค้นหาข้อมูลเพื่อพิมพ์</h2>
                        </h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                    ...
                    <div class="form-row justify-content-center align-items-center form-control-lg">
                        <div class="col-auto">
                            <div id="studentInfo" class="callout callout-info d-none">
                                    ...
                                    <button id="printButton" class="btn btn-success mt-3 d-none"><i class="nav-icon fas fas fa-print"></i> พิมพ์บัตรประจำตัวสอบ</button>
                            </div>
                        </div>
                    </div>
                 </div>
    ...
    .then(data => {
        ...
        if (data.exists) {
            ...
            document.getElementById('printButton').addEventListener('click', function() {
                window.location.href = `print_card.php?citizenid=${data.citizenid}`;
            });
