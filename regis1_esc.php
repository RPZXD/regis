      ...
      <div class="register-box col-md-12 col-12">
        <div class="card card-outline card-primary">
          <div class="card-header text-center">
            <h3>สมัครเรียนมัธยมศึกษาปีที่ 1 ห้องเรียนพิเศษ</h3>
          </div>
          <div class="card-body">
            ...
            <form id="regForm" method="POST" enctype="multipart/form-data">
              ...
              <div id="steps">
                <!-- ขั้นตอนที่ 1 ถึง 7 -->
                <div class="tab"><?php include 'stepregm1_esc/step1.php'; ?></div>
                <div class="tab"><?php include 'stepregm1_esc/step2.php'; ?></div>
                <div class="tab"><?php include 'stepregm1_esc/step3.php'; ?></div>
                <div class="tab"><?php include 'stepregm1_esc/step4.php'; ?></div>
                <div class="tab"><?php include 'stepregm1_esc/step5.php'; ?></div>
                <div class="tab"><?php include 'stepregm1_esc/step6.php'; ?></div>
                <div class="tab"><?php include 'stepregm1_esc/step7.php'; ?></div>
      ...
      if (data.success) { 
        ...
        Swal.fire({
                  ...
                  if (result.isConfirmed || result.isDismissed) {
                    ...
                    window.location.href = 'regis1_esc.php'; // เปลี่ยน URL ที่ต้องการ
                  }
                });
      }
    })
...
function check() {
  const d = document;
  const myArray = Array.from({length: 10}, (_, i) =>
